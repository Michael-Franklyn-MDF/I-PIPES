  ...
  <main class="main-content">
    ...
    <div class="stats-row">
      ...
      <div class="stat-card">
        ...
        <div class="stat-sub">3 roles</div>
      </div>
    </div>
    ...
    <div class="two-col">
      ...
      <div class="card">
        ...
        <ul style="margin-left:16px; font-size:13px; color:var(--muted); line-height:1.6;">
          <li>Latest evaluation completed with a moderate overall score.</li>
          <li>Digital skills dimension remains the weakest area.</li>
          <li>Two new policies were created in the last month.</li>
        </ul>
      </div>
    </div>
  </main>
